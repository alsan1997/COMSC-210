...
int main()
{
  ...
  // testing copy assignment
  {
    ...
    const LinkedArray<int> copya = a;
    const LinkedArray<int> copyb = b;
  ...
  {
    LinkedArray<int> copy2a; copy2a = a;
    LinkedArray<int> copy2b; copy2b = b;
