...
#include <cassert>
#include "Queue.h"
#include "Queue.h" // ifndef testing
...
int main()
{
  ...
  cout << "Data in order is: 20, 40, 60, 70\n\n";

  cout << "=========Testing peek function========\n";
  int peekValue;
  a.peek(peekValue);
  cout << "Expected: peekValue should be 20\n";
  ...
  int newpeekValue;
  a.peek(newpeekValue);
  cout << "Expected: Peek now is 40\n";
  cout << "Result: Peek is " << newpeekValue << endl << endl;
  assert(newpeekValue == 40);
  ...
  // testing copy assignment
  {
    ...
    const Queue<int> copya = a;
    int testing;

    for(Queue<int> copy = copya; !copy.empty(); copy.pop(testing))
    {
      copy.peek(testing);
      cout << testing << " ";
    }
  ...
  // testing reading assignment
  {
    ...
    for(Queue<int> copy = copyb; !copy.empty(); copy.pop(testing))
    {
      copy.peek(testing);
      cout << testing << " ";
    }
